  ...
  test-update-file:
    ...
    steps:
      ...
      - name: Update values.yaml
        uses: step-security/yaml-update-action@v0
        with:
          valueFile: 'file.yaml'
...
### Advanced Example with a separate target repository
